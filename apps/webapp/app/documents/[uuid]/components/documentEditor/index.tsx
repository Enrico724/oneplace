...
import { convertFromRaw, convertToRaw, EditorState, ContentState, Editor, RawDraftContentState } from 'draft-js';
...
const DocumentEditor = ({ uuid, initialRawContent, users, socket, isReadOnly }: DocumentEditorProps) => { 
    ...
    const [editorState, setEditorState] = useState<EditorState>(EditorState.createWithContent(initial));
    ...
    return (
        <div>
            <div className="toolbar">
                {/* Render your toolbar components here */}
            </div>
