...
const CreateFolderButton: React.FC<CreateFolderButtonProps> = (props) => {
    ...
    const onChange = (e: React.ChangeEvent<HTMLInputElement>): void => setFolderName(e.target.value);

    function createFolder() {
        const input: CreateFolderDto = { name: folderName, parentFolderId: props.folderId }
        console.log('Creating folder', input);
        api.folder.folderControllerCreateFolder(input)
