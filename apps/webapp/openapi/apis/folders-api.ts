...
export const FoldersApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    folderControllerDownloadFolder: async (
      id: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling folderControllerDownloadFolder.",
        );
      }
      const localVarPath = `/folders/{id}/download`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    folderControllerGetFolder: async (
      id: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling folderControllerGetFolder.",
        );
      }
      const localVarPath = `/folders/{id}`.replace(
        `{${"id"}}`,
     ...
     * @throws {RequiredError}
     */
    folderControllerGetRootFolder: async (
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
...
export const FoldersApiFp = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    async folderControllerDownloadFolder(
      id: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>
    > {
      const localVarAxiosArgs = await FoldersApiAxiosParamCreator(
        configuration,
      ).folderControllerDownloadFolder(id, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH,
      ) => {
     ...
     * @throws {RequiredError}
     */
    async folderControllerGetFolder(
      id: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs = await FoldersApiAxiosParamCreator(
        configuration,
      ).folderControllerGetFolder(id, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH,
      ) => {
     ...
     * @throws {RequiredError}
     */
    async folderControllerGetRootFolder(
      options?: AxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
    ...
    > {
      const localVarAxiosArgs =
        await FoldersApiAxiosParamCreator(
          configuration,
        ).folderControllerGetRootFolder(options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH,
      ) => {
...
export class FoldersApi extends BaseAPI {
   ...
   * @memberof FoldersApi
   */
  public async folderControllerDownloadFolder(
    id: string,
    options?: AxiosRequestConfig,
  ): Promise<AxiosResponse<void>> {
    return FoldersApiFp(this.configuration)
   ...
   * @memberof FoldersApi
   */
  public async folderControllerGetFolder(
    id: string,
    options?: AxiosRequestConfig,
  ): Promise<AxiosResponse<Folder>> {
    return FoldersApiFp(this.configuration)
   ...
   * @memberof FoldersApi
   */
  public async folderControllerGetRootFolder(
    options?: AxiosRequestConfig,
  ): Promise<AxiosResponse<Folder>> {
    return FoldersApiFp(this.configuration)
      .folderControllerGetRootFolder(options)
